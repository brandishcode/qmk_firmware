...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_MINS, KC_EQL,  KC_Q,    KC_J,    KC_K,    KC_X,    KC_INS,  KC_SCLN, KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,   KC_RSFT,
        JP_MHEN, JP_HENK, KC_PSCR, KC_LALT, MO(2),   KC_LSFT, KC_LCTL, KC_LGUI, KC_SPC,  MO(1),   KC_RALT, KC_LGUI, KC_END, KC_RCTL
    ),
        [1] = LAYOUT(
        RGB_TOG, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,
        KC_CAPS, KC_QUOT, KC_LBRC, KC_RBRC, KC_NUHS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_COPY, KC_PASTE,KC_TRNS, KC_RIGHT,KC_F11,
        KC_GRV,  KC_BSLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_TRNS, KC_TRNS, KC_TRNS, KC_F12,
